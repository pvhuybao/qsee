...
const iconBtn =
  "inline-flex h-9 w-9 items-center justify-center rounded border border-transparent text-white shadow-sm transition hover:opacity-90";
