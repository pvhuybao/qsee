      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div
              className="mb-12 rounded-xs bg-white px-8 py-8 shadow-three dark:bg-gray-dark lg:mb-5 lg:px-8"
              data-wow-delay=".15s"
            >
              ...
              <p className="mb-12 text-base font-medium text-body-color">
                Bộ phận kinh doanh và kỹ thuật sẽ phản hồi theo hình thức bạn
